...
@section('content')
    ...
    <div class="search-form">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <form id="search-form" style="margin-top: 25px;" method="POST" role="search" action="{{route('traveling.deals.search')}}">
                        @csrf
                        <div class="row">
                            <div class="col-lg-2">
                                <h4>Sort Deals By:</h4>
    ...
    <div class="amazing-deals">
        <div class="container">
            <div class="row">
                    ...
                    <div class="col-lg-6 col-sm-6">
                        <div class="item">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="image">
                                        <img src="{{ asset('assets/images/' . $search->image) }}" alt="">
                                    </div>
                                </div>
                                    ...
                                    <div class="content">
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                ...
                                                <span class="list">{{ $search->num_days }} Days</span>
                                            </div>
                                            <div class="col-6">
                                                <i class="fa fa-map"></i>
                                        ...
                                        <div class="main-button">
                                            <a href="{{ route('traveling.reservation', $search->id) }}">Make a Reservation</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                @endforeach
                @else
                <p class="alert alert-success">We have no result for the research you made</p>
                @endif
